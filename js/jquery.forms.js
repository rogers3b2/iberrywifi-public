jQuery(document).ready(function() {
    ...
    // footer contact
      ...
      var contactform = $('#contactformfooter');

    var contactMessages = $('#messagecontact');
    ...
    $(contactform).submit(function(e) {
        ...
        $.post(action, $(contactform).serialize(),
            ...
            function(data) {
                ...
                if (data.match('success') != null) $('#contactformfooter .form-group, #contactformfooter .btn').slideUp('slow');
